        ...
        duration: 0.6
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input id="name" placeholder="Your name" maxLength={100} value={form.name} onChange={e => setForm({
              ...form,
              name: e.target.value
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="your@email.com" maxLength={255} value={form.email} onChange={e => setForm({
              ...form,
            ...
            <div className="space-y-2">
              ...
              <Textarea id="message" placeholder="What's on your mind?" rows={5} maxLength={1000} value={form.message} onChange={e => setForm({
              ...form,
              message: e.target.value
            })} className="bg-card border-border focus:border-primary resize-none" />
            </div>
            <Button type="submit" size="lg" className="w-full font-mono text-sm" disabled={sent}>
              {sent ? <>
